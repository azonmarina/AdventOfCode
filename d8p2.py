...
# characters in the original code representation (23, just like in the first
# part of this puzzle) is 42 - 23 = 19.

import fileinput
import re

part2 = sum(len("\""+re.escape(line.strip())+"\"") - len(line.strip()) for line in fileinput.input('input8')) 

print 'Part 2: The length is {}'.format(part2)
